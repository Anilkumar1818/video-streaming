...
class VideoStreamer(object):
    def __init__(self):
        ...
        self.VS_CAMFEED_API_ENDPOINT = 'http://'+HOST_IP+':5101/videoStreaming/camFeed'
    ...
    def stream_video_1(self):
        ...
        while(cap.isOpened()):
            ...
            r =requests.post(url = self.VS_CAMFEED_API_ENDPOINT, data =jpgframe,headers={'Content-type': 'image/jpeg'})
